...
### 🎨 Frontend
<p align="center">
  <img src="https://skillicons.dev/icons?i=react,vue,nextjs,nuxtjs,tailwind,vuetify,bootstrap" />
</p>

### 🗄️ Backend & Databases
<p align="center">
  <img src="https://skillicons.dev/icons?i=mongodb,postgres,firebase,redis,prisma,supabase,aws,fastapi,express,nestjs" />
...
- **💼 Financial Advice Company landing page
- **🛍️ Store Management system
- **🎨 Own Portfolio Website**
- **📹 YouTube Channel** – Creating developer content
- **⚡ Boycott website** - Using my skills for good causes

### 📚 Learning & Improving
- **Solid.js** – Deep dive into functional programming
- **Vue.js** – Mastering the ecosystem
- **Elm & React** – Comparative study
- **Java Reduction** – Working to bring below 10% usage
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=doubleyooz&label=Profile%20Views&color=0e75b6&style=flat" alt="profile views" />
